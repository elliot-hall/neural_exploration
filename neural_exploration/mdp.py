...
class MDPFeatures():
    ...
    def reset_rewards(self):
        ...
        self.rewards = np.array(
            [
                ...
                for h, s, a in itertools.product(range(self.H), self.states, self.actions)
            ]
    ...
    def sanity_policy(self):
        ...
        assert np.array_equal(self.evaluate_policy(pi_star), V_star), 'Check the implementation of backward induction for value iteration!'
